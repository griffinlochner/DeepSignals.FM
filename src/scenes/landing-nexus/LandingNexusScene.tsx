...
function LandingNexusScene({ reducedMotion = false }: LandingNexusSceneProps) {
  ...
  return <div ref={mountRef} className="landing-nexus-scene" aria-hidden="true" />
}

export default LandingNexusScene
