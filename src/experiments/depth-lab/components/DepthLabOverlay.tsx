...
function DepthLabOverlay({ status, children }: DepthLabOverlayProps) {
  return (
    <aside className="depth-lab__overlay">
      ...
      <h1 className="depth-lab__title">
        Depth-image motion and immersion laboratory
      </h1>
      <p className="depth-lab__caption">
        Tune conservative depth motion profiles for displaced-image staging and
        immersive response behavior.
      </p>
      {children}
